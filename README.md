...
The repository serves as a poor particle physicist cookbook by providing the weak-scale dark matter (DM) induced cosmic-ray (CR) fluxes for $\bar{p}$ and $\bar{D}$ COMMENT
